...
namespace Zene.Structs
{
    public struct Vector4I
    {
        ...
        public Vector3I MultiplyMatrix(Matrix3x4 matrix)
        {
            return new Vector3I(
                (matrix[0, 0] * X) + (matrix[1, 0] * Y) + (matrix[2, 0] * Z) + (matrix[3, 0] * W),
                (matrix[0, 1] * X) + (matrix[1, 1] * Y) + (matrix[2, 0] * Z) + (matrix[3, 1] * W),
                (matrix[0, 2] * X) + (matrix[1, 2] * Y) + (matrix[2, 0] * Z) + (matrix[3, 2] * W));
        }
        public Vector4I MultiplyMatrix(Matrix4 matrix)
        {
            return new Vector4I(
                (matrix[0, 0] * X) + (matrix[1, 0] * Y) + (matrix[2, 0] * Z) + (matrix[3, 0] * W),
                (matrix[0, 1] * X) + (matrix[1, 0] * Y) + (matrix[2, 0] * Z) + (matrix[3, 1] * W),
                (matrix[0, 2] * X) + (matrix[1, 0] * Y) + (matrix[2, 0] * Z) + (matrix[3, 2] * W),
                (matrix[0, 3] * X) + (matrix[1, 0] * Y) + (matrix[2, 0] * Z) + (matrix[3, 3] * W));
        }
