...
namespace Zene.Graphics
{
    ...
    /// </summary>
    public class Texture3DComp : ITexture
    {
        /// <summary>
        ...
        public Texture3DComp(TextureTarget target, TextureFormat format)
        {
            if (!target.Is2D())
            {
        ...
        internal Texture3DComp(TextureTarget target, uint id, TextureFormat format)
        {
        ...
        public void SetData<T>(int level, int width, int height, int depth, GLArray<T> data) where T : unmanaged
        {
            
            _texture.CompressedTexImage3D(level, InternalFormat, width, height, depth, data);
        }
        /// <summary>
        /// Create a texture from <paramref name="data"/>.
        /// </summary>
        ...
        /// <param name="height">The height of the texture</param>
        /// <param name="data">The data to set the texture to.</param>
        public void SetData<T>(int width, int height, int depth, GLArray<T> data) where T : unmanaged => SetData(0, width, height, depth, data);
        ...
        public void EditData<T>(int level, int x, int y, int z, int width, int height, int depth, GLArray<T> data) where T : unmanaged
        {
            
            _texture.CompressedTexSubImage3D(level, x, y, z, width, height, depth, data);
        }
        /// <summary>
        /// Change the data of a section of the texture.
        /// </summary>
        ...
        /// <param name="height">The height of the section.</param>
        /// <param name="data">The data to change the scetion to.</param>
        public void EditData<T>(int x, int y, int z, int width, int height, int depth, GLArray<T> data) where T : unmanaged => EditData(0, x, y, z, width, height, depth, data);
        ...
        public unsafe T[] GetDataSection<T>(int level, int x, int y, int z, int width, int height, int depth, int bufferSize) where T : unmanaged
        {
            
            return _texture.GetCompressedTextureSubImage<T>(level, x, y, z, width, height, depth, bufferSize);
        }
        /// <summary>
        /// Returns a section of the data stored in this texture.
        /// </summary>
        ...
        public T[] GetDataSection<T>(int x, int y, int z, int width, int height, int depth, int bufferSize) where T : unmanaged
            => GetDataSection<T>(0, x, y, z, width, height, depth, bufferSize);
        ...
        public static Texture3DComp Create<T>(TextureTarget target, TextureFormat format, GLArray<T> data, int width, int height, int depth) where T : unmanaged
        {
            Texture3DComp texture = new Texture3DComp(target, format);
