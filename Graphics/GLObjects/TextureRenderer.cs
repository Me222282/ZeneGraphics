...
namespace Zene.Graphics
{
    ...
    public class TextureRenderer : IFrameBuffer
    {
        ...
        public TextureRenderer(int width, int height)
        {
            ...
            _colourAttachs = new Texture2D[IFrameBuffer.MaxColourAttach()];
        }
        ...
        public void SetColourAttachment(int attachment, TextureFormat intFormat)
        {
            ...
            texture.TexImage2D(0, Width, Height, BaseFormat.Rgb, texture.DataType, IntPtr.Zero);
        ...
        public void SetDepthAttachment(TextureFormat intFormat, bool isTexture)
        {
            ...
            {
                Texture2D texture = new Texture2D(intFormat, TextureData.Byte);
                texture.TexImage2D(0, Width, Height, BaseFormat.DepthComponent, texture.DataType, IntPtr.Zero);
                texture.MinFilter = TextureSampling.Nearest;
                texture.MagFilter = TextureSampling.Nearest;
            ...
            renderbuffer.RenderbufferStorage(intFormat, Width, Height);
        ...
        public Vector2I Size
        {
            ...
            set
            {
                ...
                if (_depthTex != null)
                {
                    _depthTex.TexImage2D(0, Width, Height, BaseFormat.DepthComponent, _depthTex.DataType, IntPtr.Zero);
                    _depthTex.UnBind();
                    return;
                }
                ...
                if (_depthRen != null)
                {
                    _depthRen.RenderbufferStorage(Width, Height);
                    _depthRen.UnBind();
                    return;
                }
